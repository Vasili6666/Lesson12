...
public class SimpleJUnitTest extends TestBase {
   ...
   @Test
    void fillFormTest() {
        ...
        step("Проверяем заполненную таблицу", () -> {
            $(".modal-content").shouldBe(visible);
            $(".table-responsive").$(byText("Student Name")).parent().shouldHave(text("Basil Pupkin"));
            $(".table-responsive").$(byText("Student Email")).parent().shouldHave(text("pupkin@basil.com"));
            $(".table-responsive").$(byText("Gender")).parent().shouldHave(text("Male"));
            $(".table-responsive").$(byText("Mobile")).parent().shouldHave(text("0441234567"));
            $(".table-responsive").$(byText("Date of Birth")).parent().shouldHave(text("06 February,1982"));
            ...
            $(".table-responsive").$(byText("Picture")).parent().shouldHave(text("Foto 07.2024.jpg"));
            $(".table-responsive").$(byText("Address")).parent().shouldHave(text("Площадь Пушкина, пр-д Калатушкина, 6"));
